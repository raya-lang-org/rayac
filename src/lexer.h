...
typedef enum {
    ...
    TOK_CONTINUE, TOK_UNION, TOK_STRUCT, TOK_UNSAFE, TOK_NORETURN, 
    TOK_TYPE, TOK_TRAITS, TOK_EXTEND, TOK_MATCH, TOK_ENUM, 
    TOK_AS,TOK_WITH, TOK_UNDEFINED, TOK_SELF, TOK_CAP_SELF,
...
static inline const char* token_kind_name(TokenKind k) {
    static const char* names[] = {
        ...
        "continue", "union", "struct", "unsafe", "noreturn",
